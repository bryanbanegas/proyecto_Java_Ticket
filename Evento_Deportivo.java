...
public class Evento_Deportivo extends Evento {
    ...
    public Evento_Deportivo(String codigo, String clase, String titulo, String descripcion, Date fecha, double monto, int cantidad, String equipo1, 
            String equipo2, String tipo) {
